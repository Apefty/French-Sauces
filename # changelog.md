...
### Додано
- Повноцінний WINDOWS-порт застосунку (Capacitor), протестований через USB на реальному пристрої (Redmi 9).
- Власна іконка застосунку.

### Виправлено
- Прибрано CDN-залежності (Font Awesome, Iconify) — застосунок тепер повністю офлайн, однаково для Windows і WINDOWS.
